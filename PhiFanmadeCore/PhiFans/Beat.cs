...
namespace PhiFanmade.Core.PhiFans
{
    public static partial class PhiFans
    {
        ...
        /// 使用int[]隐式转换时，返回原始数组
        /// </summary>
        [Newtonsoft.Json.JsonConverter(typeof(RePhiEdit.RePhiEdit.BeatJsonConverter))]
#if !NETSTANDARD2_1
        [System.Text.Json.Serialization.JsonConverter(typeof(RePhiEdit.RePhiEdit.StjBeatJsonConverter))]
#endif
