...
public class NoteTypeConverter : JsonConverter<NoteType>
{
    ...
    public override NoteType ReadJson(JsonReader reader, Type objectType, NoteType existingValue, bool hasExistingValue,
        JsonSerializer serializer)
    {
        return reader.Value switch
        {
            long longValue => (NoteType)longValue,
...
public class AttachUiConverter : JsonConverter<AttachUi?>
{
    ...
    public override AttachUi? ReadJson(JsonReader reader, Type objectType, AttachUi? existingValue, bool hasExistingValue,
        JsonSerializer serializer)
    {
