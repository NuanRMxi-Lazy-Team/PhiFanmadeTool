...
public class Easing(int easingNumber)
{
    private int _easingNumber = easingNumber;
...
public class EasingJsonConverter : JsonConverter<Easing>
{
    ...
    public override Easing ReadJson(JsonReader reader, Type objectType, Easing existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
